...
/// "No speech detected" for every cause.
/// </summary>
/// <remarks>
/// This is the user-facing half of the failure-reason fix: the pipeline classifies *why* a dictation
/// ended; this helper turns that classification into a toast title, body and severity.
/// </remarks>
public static class FailureMessages
{
    ...
    /// <summary>
    /// Builds the notification for an empty-text outcome.
    /// </summary>
    /// <param name="failure">The pipeline's failure classification.</param>
    /// <returns>Title/body/severity for the toast.</returns>
    /// <example>For(DictationFailure.EngineNotReady) → error toast pointing at Settings › System status.</example>
